...
pub fn build_router(app_state: AppState) -> Router {
    ...
    Router::new()
        ...
        .route("/api/search/stream", get(api::search::search_stream))
        .route("/api/detail", get(api::search::get_detail))
        .route("/api/play/parse", get(api::play::parse_play_url))
        .route("/proxy/m3u8", get(api::media_proxy::proxy_m3u8))
        .route("/proxy/segment", get(api::media_proxy::proxy_segment))
        .route("/proxy/key", get(api::media_proxy::proxy_key))
